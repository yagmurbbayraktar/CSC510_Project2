# Class Description for JobCruncher
...
### Class: App
User interface for job cruncher platform, running on a browser screen. For the interface Flask has been used. Multiple functionalities are supported such as search job via skills set
